...
Throughout this section $R=L_{\F_2}(1,2)$ and $q=s_1t_1$, so that
$s_0t_0+q=1$ and $t_1qs_1=1$; in particular $q\ne0$.  By~\eqref{eq:leavitt},
the maps $x\mapsto(t_0x,t_1x)$ and $(y,z)\mapsto s_0y+s_1z$ are mutually
inverse isomorphisms of right $R$-modules between $R$ and $R\oplus R$.
With $s=s_0$ and $t=t_0$ the
