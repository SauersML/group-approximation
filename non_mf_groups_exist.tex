...
amalgamation of that group realizes any finitely presented sofic group
as the largest MF quotient of a finitely presented sofic non-MF group,
preserving its profinite completion and its rational cohomology.  Finally, we construct
...
eight generators.  The $\bar\Gamma$-action on the eight generators is
the affine action on $\mathbb F_2^3$, through
$\bar\Gamma\to\bar\Gamma/\alpha(\bar\Gamma)$.
