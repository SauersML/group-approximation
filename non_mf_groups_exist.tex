...
For a concrete instance, takeIt is residually finite, since reduction modulo a suitable integer
...
corona when the normal subgroup has property~\textup{(T)}.
...
The radical of Theorem~\ref{thm:amenable-trace} contains torsion.
\end{enumerate}
