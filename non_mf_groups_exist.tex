...
$\sqrt{\mu_n}$.  Some such bound is needed: a rank-one projection in
$M_d(\mathbb C)$ has operator norm $1$ and normalized
Hilbert--Schmidt norm $d^{-1/2}$, so on a summand whose relative size
tends to zero, equivalence of norms on a fixed finite-dimensional
algebra gives nothing uniform.
