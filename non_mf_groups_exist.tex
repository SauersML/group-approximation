...
projection onto the first basis vector, and $JeJ$ is the ring of finite
matrices, so the kernel of $\EL_n(J)\to\EL_n(\F_2[z,z^{-1}])$ consists of
the finitary automorphisms of $V^n$.  Over $\F_2$ these are products of
...
and is finite: Theorem~\ref{thm:compression-criterion} has no Kazhdan
subgroup to act on at rank two.  Three coordinates carry
...
theorem~\cite[Theorem~7.1(a), (b), and (e)]{Hull}.
