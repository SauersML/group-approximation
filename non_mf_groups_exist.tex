...
the existing work (it had access to the repository and thousands of
pages of the agents' notes), with this prompt:
\begin{quote}
...
result.  You got this!''
\end{quote}
Instead of doing that, Sol said it had come up with an MF
counterexample: every norm-matrix model of the Clifford-twisted wreath
product has to kill the Clifford sign.  That was on August~9, and the
same day's notes record that the maximal group $C^*$-algebra of a
strictly compressed Kazhdan group is infinite.  Other parallel chats without the
...
reviews by Astra.  The commit history of the public repository shows
the exchange.  The one-sided transport
...
to the AIs.  Other parallel agents without the MF idea (including
``Pro'' mode) did not discover the key MF result.  In September 2026
Astra reviewed the manuscript, proposed the cuts and repairs that
shaped the September revision, recommended promoting
Theorem~\ref{thm:amenable-trace} to a main theorem, and supplied the
argument printed in the proof of Theorem~\ref{thm:normal-kazhdan}.
The Lean development was registered at Palomar on August~24, 2026
(PALOMAR-2026-08-24-000006).  The statements that were checked
