...
Sol's original counterexample, with the affine group
$\mathbb Z^3\rtimes\mathrm{SL}_3(\mathbb Z)$ as the Kazhdan subgroup,
is the group $W$ of Theorem~\ref{thm:amenable-trace}.\footnote{The
Lean proof was registered at Palomar on August~24, 2026:
\url{https://palomar-registry.org/entry?id=PALOMAR-2026-08-24-000006&version=1}.}  The counterexample of this paper is
\[
 H=\EL_{12}(L_{\F_2}(1,2)),
\]
...
is isomorphic to $H$; the Lean proofs use rank~$12$.}  OpenAI used this group to construct the first nonsofic
