...
(t_is_j-\delta_{ij}:i,j\in\{0,1\})$, and the group
$B=\EL_4(\mathcal C)$ then maps
...
unique tracial state, and is not MF.
\end{mainthm}
...
$B$.  It forces all MF maps to kill $E$, while soficity is preserved
...
lemmas then carry the conclusion from $B$ to every $\EL_n(R)$.  The
...
$u=u_3u_2u_1\in\EL_4(\mathcal C)$ is the matrix
\[
 u=
 \begin{pmatrix}
 s&0&0&e\\
...
Theorem~\ref{thm:fp-sofic-radical}, with root coordinate
$(A_5)_\Gamma$.  Choose
\[
 x=\begin{pmatrix}0&1&0\\0&0&1\\1&0&0\end{pmatrix}
       \in\mathrm{SL}_3(\mathbb Z),
 \qquad a=(12)(34),\quad b=(123)\in(A_5)_\Gamma,
\]
and set
