...
group homomorphism
$\GL_3(R)\to\GL_3(R)$, and the identity $t_0\Psi(A)s_0=A$ shows that
this homomorphism is injective.  Put
\[
...
\begin{proof}
The ring $R$ is generated by $s_0,s_1,t_0,t_1$ as a unital ring, so
$\EL_{12}(R)$ and $\EL_3(R)$ have property~\textup{(T)} by the theorem of
Ershov and Jaikin-Zapirain~\cite[Theorem~1.1]{EJZ}.  By
Lemma~\ref{lem:tau-elementary}, $\tau\in H$.  For $i\ne j$ and
