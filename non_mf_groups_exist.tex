...
cancellation theorem again applies.  Theorem~\ref{thm:hull} therefore
holds for $N_0$ and $A'$; as with $A$, passing from injectivity on a ball
to injectivity on $\Omega$ uses that every finite subset of $G$ lies in a
ball of $\operatorname{Cay}(G,A')$.  Apply
