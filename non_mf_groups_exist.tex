...
finite $C^*$-algebra is quasidiagonal.  This was a question about nuclear
$C^*$-algebras, not about arbitrary groups.  Carri\'on, Dadarlat, and
Eckhardt introduced the group property used here~\cite{CDE}.  If every
separable stably finite $C^*$-algebra were MF, the MF
problem~\cite[\S6]{GoldbringHart}, then every countable group would be
MF, because its reduced group $C^*$-algebra is separable and stably
finite; later approximation papers described the resulting operator norm
group problem as related to Kirchberg's
question~\cite{LubotzkyOppenheim,Thom}.  The MF problem was answered
negatively through the failure of the Connes embedding
problem~\cite{MIPRE}\cite[Proposition~6.1 and Remark~6.2]{GoldbringHart},
and Theorem~\ref{thm:headline} gives a counterexample among reduced group
$C^*$-algebras.  Whether every countable group is MF was a longstanding
open problem~\cite{Korchagin,BDL}.
