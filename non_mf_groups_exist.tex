...
Theorem~\ref{thm:normal-kazhdan}.  We highly recommend Eckhardt's
...
algebra, because $H$ fails MF in the strongest way: it is simple, and
every homomorphism from it to an MF group is trivial.  Khanh--Thanh show that $H$ is isomorphic to the unit group of the
