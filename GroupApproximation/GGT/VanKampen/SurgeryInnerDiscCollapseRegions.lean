import GroupApproximation.GGT.VanKampen.SurgeryInnerDiscCollapseDarts
...
The second half of the transport through `InnerDiscRegion.diagram`.  A face set `s`
...
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.transportBoundary
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.shelling
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.contiguityGeometry
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.regionCandidate_injective
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.regionFamily_card
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.regionFamily_weight
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.regionFamily_pairwise
