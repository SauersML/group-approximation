...
noncomputable def toLemma65CutData (cut : RegionCutWithGCells Delta)
...
theorem diagram_outerDarts_map_val (cut : RegionCutWithGCells Delta) :
...
theorem exists_boundarySections_of_partition
    (cut : RegionCutWithGCells Delta) (D : RelGenSet G Lambda) (lambda c : ℝ)
...
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.MapCollapse.RegionCutWithGCells.diagram_outerDarts_map_val
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.MapCollapse.RegionCutWithGCells.exists_boundarySections_of_partition
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.MapCollapse.RegionCutWithGCells.exists_lemma65CutData_of_partition

#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.MapCollapse.RegionCutWithGCells.toLemma65CutData
