...
theorem cyclicArcLengths_le_two_mu_cellPerimeter
    {G : Type u} [Group G] {Lambda : Type w}
    {D : GGT.RelGenSet G Lambda}
    {W : Set (List (GGT.RelLetter G Lambda))}
    {Delta : DiscDiagram.{u, w, v} W} {eps rho : ℕ} {mu : ℝ}
...
in the exact `2 * mu * cell perimeter` form. -/
theorem arcLengths_le_two_mu_cellPerimeter_of_cellTarget
    {G : Type u} [Group G] {Lambda : Type w}
    {D : GGT.RelGenSet G Lambda}
    {W : Set (List (GGT.RelLetter G Lambda))}
    {Delta : DiscDiagram.{u, w, v} W} {eps rho : ℕ} {mu : ℝ}
  ...
  exact cyclicArcLengths_le_two_mu_cellPerimeter hsc Gamma.sourceArc
    (Gamma.cellTargetArc target htarget) Gamma.leftSide_norm_le
    Gamma.rightSide_norm_le harcs hwhole
...
theorem arcLengths_le_two_mu_cellPerimeter_source_of_cellContiguity
    {G : Type u} [Group G] {Lambda : Type w}
    {D : GGT.RelGenSet G Lambda}
    {W : Set (List (GGT.RelLetter G Lambda))}
    {Delta : DiscDiagram.{u, w, v} W} {eps rho : ℕ} {mu : ℝ}
  ...
  calc
    ...
    _ = 2 * mu * ((cell Delta Gamma.source).word.length : ℝ) := by
      rw [hsource]
      rfl
...
theorem arcWeight_le_two_mu_cellPerimeter_source_of_cellContiguity
    {G : Type u} [Group G] {Lambda : Type w}
    {D : GGT.RelGenSet G Lambda}
    {W : Set (List (GGT.RelLetter G Lambda))}
    {Delta : DiscDiagram.{u, w, v} W} {eps rho : ℕ} {mu : ℝ}
  ...
  simpa only [Nat.cast_add] using
    Gamma.arcLengths_le_two_mu_cellPerimeter_source_of_cellContiguity
      cellGamma hsource hsourceArc htargetArc hsc hred

/-- The corresponding transfer at the target incidence has exactly the same
`2 * mu * cell perimeter` conclusion. -/
theorem arcLengths_le_two_mu_cellPerimeter_target_of_cellContiguity
    {G : Type u} [Group G] {Lambda : Type w}
    {D : GGT.RelGenSet G Lambda}
    {W : Set (List (GGT.RelLetter G Lambda))}
    {Delta : DiscDiagram.{u, w, v} W} {eps rho : ℕ} {mu : ℝ}
    ...
    (hred : Delta.Reduced) :
    (Gamma.sourceArc.length : ℝ) + (Gamma.targetArc.length : ℝ) ≤
      2 * mu * ((cell Delta target).word.length : ℝ) := by
  calc
    (Gamma.sourceArc.length : ℝ) + (Gamma.targetArc.length : ℝ) =
        (cellGamma.region.firstArc.length : ℝ) +
          (cellGamma.region.secondArc.length : ℝ) := by
    ...
    _ = 2 * mu * ((cell Delta target).word.length : ℝ) := by
      rw [htarget]
      rfl

/-- The target-incidence estimate with the arc sum cast from `Nat`, matching
the representation used by `Embedded.Candidate.weight`. -/
theorem arcWeight_le_two_mu_cellPerimeter_target_of_cellContiguity
    {G : Type u} [Group G] {Lambda : Type w}
    {D : GGT.RelGenSet G Lambda}
    {W : Set (List (GGT.RelLetter G Lambda))}
    {Delta : DiscDiagram.{u, w, v} W} {eps rho : ℕ} {mu : ℝ}
    ...
    ((Gamma.sourceArc.length + Gamma.targetArc.length : ℕ) : ℝ) ≤
      2 * mu * ((cell Delta target).word.length : ℝ) := by
  simpa only [Nat.cast_add] using
    Gamma.arcLengths_le_two_mu_cellPerimeter_target_of_cellContiguity target
...
theorem weight_le_two_mu_cellPerimeter_source_of_cellContiguity
    {G : Type u} [Group G] {Lambda : Type w}
    {D : GGT.RelGenSet G Lambda}
    {W : Set (List (GGT.RelLetter G Lambda))}
    {Delta : DiscDiagram.{u, w, v} W} {eps rho : ℕ} {mu : ℝ}
  ...
  exact candidate.contiguity.arcWeight_le_two_mu_cellPerimeter_source_of_cellContiguity
    cellGamma hsource hsourceArc htargetArc hsc hred

/-- A certified O52 region fills the target endpoint of
`EstimatingData.edgeWeight_le_incident` with `Candidate.weight`. -/
theorem weight_le_two_mu_cellPerimeter_target_of_cellContiguity
    {G : Type u} [Group G] {Lambda : Type w}
    {D : GGT.RelGenSet G Lambda}
    {W : Set (List (GGT.RelLetter G Lambda))}
    {Delta : DiscDiagram.{u, w, v} W} {eps rho : ℕ} {mu : ℝ}
  ...
  change ((candidate.contiguity.sourceArc.length +
    candidate.contiguity.targetArc.length : ℕ) : ℝ) ≤ _
  exact candidate.contiguity.arcWeight_le_two_mu_cellPerimeter_target_of_cellContiguity
