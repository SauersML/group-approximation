...
sum of those boundary lengths, which is preserved by O-equivalence. This
...
noncomputable def outerArcDarts (a : GeometricCandidate D eps Delta) :
...
theorem outerArcDarts_subset (a : GeometricCandidate D eps Delta) :
...
theorem faceOf_mem_of_mem_outerArcDarts (a : GeometricCandidate D eps Delta)
...
theorem outerArcDarts_disjoint {a b : GeometricCandidate D eps Delta}
...
theorem card_outerArcDarts (a : GeometricCandidate D eps Delta) :
...
theorem weight_eq_cell_and_outer (a : GeometricCandidate D eps Delta) :
...
theorem sum_cellArcDarts_card_le (selected : Finset (GeometricCandidate D eps Delta))
  ...
  have hd : (selected : Set (GeometricCandidate D eps Delta)).PairwiseDisjoint
...
theorem sum_outerArcDarts_card_le (selected : Finset (GeometricCandidate D eps Delta))
    (hpairwise : EstimatingSelection.PairwiseCompatible Compatible selected) :
...
theorem familyWeight_le (selected : Finset (GeometricCandidate D eps Delta))
    (hpairwise : EstimatingSelection.PairwiseCompatible Compatible selected) :
...
#audit_axioms GroupApproximation.GGT.VanKampen.Embedded.GeometricCandidate.weight_eq_cell_and_outer
#audit_axioms GroupApproximation.GGT.VanKampen.Embedded.GeometricCandidate.familyWeight_le
