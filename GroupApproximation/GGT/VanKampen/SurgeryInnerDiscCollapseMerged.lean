...
After `InnerDiscRegion.diagram` collapses a G-cell region into one face, that face
...
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.merged_noInternalFaceDart
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.merged_not_relatorFace
#audit_axioms GroupApproximation.GGT.VanKampen.Surgery.InnerDiscRegion.merged_value
