import GroupApproximation.GGT.VanKampen.GreendlingerLeaf.P05OuterCell.Transport
...
theorem hasCleanTwoGon_of_transport (hlea : Delta.LeastArea) (T : RegionTransport S S')
  ...
  refine ⟨T.noLoops hloops, T.noMultipleEdges hmulti, T.map ⟨a₀, ha₀⟩, T.map_mem _,
    by rw [T.target, hat, Option.map_none], P',
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.P05OuterCell.hasCleanTwoGon_of_transport
