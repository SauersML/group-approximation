import GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape
...
namespace GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape

universe u w v

/-- Lane gl-p04-01 in the form of `ClassStepStatement`. -/
theorem classStepStatement : ClassStepStatement.{u, w, v} :=
  fun Q k i j hi hj n d e hd he => ClassStep.sigma_succ Q k i j hi hj n d e hd he

#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape.classStepStatement

/-- Lane gl-p04-02 in the form of `ClassSidesSuccStatement`. -/
theorem classSidesSuccStatement : ClassSidesSuccStatement.{u, w, v} :=
  fun Q k i hi => ClassSidesSucc.succ Q k i hi

#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape.classSidesSuccStatement

/-- Lane gl-p04-03 in the form of `SideSuccFaceStatement`. -/
theorem sideSuccFaceStatement : SideSuccFaceStatement.{u, w, v} :=
  fun Q k s hs d t hd ht => SideSuccFace.facePerm_last Q k s hs d t hd ht

#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape.sideSuccFaceStatement
...
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape.windowHeadShape_of_split

end GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape
