...
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape.darts_eq_of_reverseDarts_eq
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape.facePerm_alpha

/-- `σ (α d) = φ d`. -/
theorem sigma_alpha (d : M.Dart) : M.sigma (M.alpha d) = M.facePerm d := by
  rw [CombMap.facePerm, Equiv.Perm.mul_apply]

#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape.sigma_alpha
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.HeadShape.headShape_of_split
