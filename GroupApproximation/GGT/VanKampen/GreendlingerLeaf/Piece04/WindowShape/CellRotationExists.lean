import GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.CellRotation
import GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.GapOffFaceBridge
...
namespace GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.CellRotation
...
theorem classDisjoint :
    GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.CellRotation.ClassDisjointStatement.{u, w, v} := by
  intro G _ Lambda W D lambda c eps Delta cuts S P Q k i i' j hi hi' hii' hk hk'
  exact GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.GapOffFace.classDisjointStatement
    Q k i i' j hi hi' hii' hk hk'

#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.CellRotation.classDisjoint
...
theorem exists_rotate :
    GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.CellRotation.CellRotationStatement.{u, w, v} :=
  exists_rotate_of_classDisjoint classDisjoint

#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.CellRotation.exists_rotate
...
theorem exists_rotate_assembly :
    GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.Assembly.CellRotationStatement.{u, w, v} := by
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.CellRotation.exists_rotate_assembly

end GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.WindowShape.CellRotation
