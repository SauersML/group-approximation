import GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurnsWalk
...
theorem passTail (h : PocketSetting M X T Y U q B p A) {g x : M.Dart} (hg : p.head? = some g)
    (hx : (X ++ T).head? = some x) : ∃ k, SafeRun M (B ++ X) g x k := by
  ...
  obtain ⟨k, hk⟩ := loop_safeRun h.planar hγnd hγchain hg₀ hg₁ he hed hdg heγ hαe hdγ hγc hc
  exact ⟨1 + k, hk.trans (SafeRun.one hnotU hed)⟩
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.passTail
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.closed_of
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.PocketSetting.head_p
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.PocketSetting.head_T
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.firstTurnClosed_X
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.mem_swap
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.faceCycle_swap
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.PocketSetting.swap
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.RotationTurns.firstTurnClosed_Y
