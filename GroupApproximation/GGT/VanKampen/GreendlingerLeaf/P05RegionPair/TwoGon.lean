import GroupApproximation.GGT.VanKampen.GreendlingerLeaf.P05RegionPair.Transport
...
theorem hasCleanTwoGon_of_transport (hlea : Delta.LeastArea) (T : RegionTransport S S')
  ...
  have hpow : ∀ (n : ℕ) (y : (phiMapO S.family (linkedComponentO S.family a₀)).Dart),
    ...
    intro n
    induction n with
    | zero => intro y; simp only [pow_zero, Perm.one_apply]
    | succ n ih =>
      intro y
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.P05RegionPair.PhiTransportAt
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.P05RegionPair.hasCleanTwoGon_of_transport
