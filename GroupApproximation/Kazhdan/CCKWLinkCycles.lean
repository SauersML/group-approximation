...
theorem linkCycles_of_typedPoints {X : Systolic.TriangleComplex V} {H : Fin 3 → Subgroup G}
  ...
  · -- length three: four pairwise distinct types
    ...
    exact h20 (types_cycle4 _ _ _ _ _ hv0 h01 hv1 h12 hv2 h12.symm hv1 h01.symm).1
  ...
  · -- length five: an odd cycle cannot alternate between two types
    ...
    have e2 := (types_cycle4 _ _ _ _ _ hv0 h01 hv1 h12 hv2 h12.symm hv1 h01.symm).1
    have e4 := (types_cycle4 _ _ _ _ _ hv2 h23 hv3 h34 hv4 h34.symm hv3 h23.symm).1
    exact h40 (e4.trans e2)
  ...
  · -- length seven: an odd cycle cannot alternate between two types
    ...
    have e2 := (types_cycle4 _ _ _ _ _ hv0 h01 hv1 h12 hv2 h12.symm hv1 h01.symm).1
    have e4 := (types_cycle4 _ _ _ _ _ hv2 h23 hv3 h34 hv4 h34.symm hv3 h23.symm).1
    have e6 := (types_cycle4 _ _ _ _ _ hv4 h45 hv5 h56 hv6 h56.symm hv5 h45.symm).1
    exact h60 (e6.trans (e4.trans e2))
