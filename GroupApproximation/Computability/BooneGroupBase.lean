...
* **S2b `TODO`, ~80 lines.**  The reverse inclusion of `closure_le_Gsub`, i.e.
...
* **S3 `TODO`, ~400--700 lines.**  The tower of Simpson's Definition 6.
...
* **S4 `TODO`, ~300--600 lines, THE HARD ONE.**  Simpson's Definition 2, the
...
* **S5b `TODO`, ~120 lines.**  Supply the isomorphism: feed S5a into S4 to get
...
* **S9 `EXTERNAL, PROSE ONLY`.**  Simpson's Theorem 4: some modular machine has
  non-computable halting set.  It is deliberately **not stated in Lean
