...
* `LiteralBaseRotationRetract.baseToRotation_ker_eq_translations` -- killing
  the translations retracts the literal base onto its eight-relator rotation
  presentation, with exactly the translation subgroup as kernel.
...
export GroupApproximation.LiteralBaseRotationRetract
  (Rotation rotationToBase baseToRotation rotationToBase_injective
    baseToRotation_ker_eq_translations translations_inf_rotations)
