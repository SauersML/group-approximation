...
`CoronaUCPFiniteCoordinateLocalizationClaim`.
...
local instance boundedMatrixSequenceCStarAlgebraForLocalizationSupportNM16
...
local instance matrixBlockCStarAlgebraForLocalizationSupportNM16
