...
*GL02 copy.*  Re-proof of the foreign module `Piece04.RotationTurns`
(origin/main blob `dc2072554`), moved to namespace `Piece04.GL02` since the modules it
...
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.rotationTurns_of_windowShape
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.rCell_of_windowShape
