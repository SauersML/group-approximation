...
*GL02 copy.*  Re-proof of the foreign module `Piece04.WindowShape.WindowTailSplit`
(origin/main blob `e54d88eb6`), moved to namespace `Piece04.GL02` since the modules it
...
namespace GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.WindowTailSplit.split

end TailSplit

end GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape
