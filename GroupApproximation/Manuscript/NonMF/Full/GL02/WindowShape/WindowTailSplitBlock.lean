...
*GL02 copy.*  Re-proof of the foreign module `Piece04.WindowShape.WindowTailSplitBlock`
(origin/main blob `6ea481fa4`), moved to namespace `Piece04.GL02` since the modules it
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.WindowTailSplit.take_drop_eq_append_last
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.WindowTailSplit.tailSplitAt_first
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.WindowTailSplit.tailSplitAt_end
