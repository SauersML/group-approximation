...
*GL02 copy.*  Re-proof of the foreign module `Piece04.WindowShape.Assembly`
(origin/main blob `dc3239767`), moved to namespace `Piece04.GL02` since the modules it
...
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.Assembly.windowShape_of_shapes
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.Assembly.proof_of_shapes
#audit_axioms
  GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.Assembly.rCell_of_shapes
