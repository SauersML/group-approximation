...
*GL02 copy.*  Re-proof of the foreign module `Piece04.WindowShape.ClassDisjoint`
(origin/main blob `ac54c4ebb`), moved to namespace `Piece04.GL02`.  Its import closure
contains a module using a deprecated Lean core lemma.  Otherwise only namespaces, the
...
namespace GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.ClassDisjoint
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.ClassDisjoint.GapOffFaceStatement
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.ClassDisjoint.ClassDisjointStatement
    ...
    · rcases side_or_gap_succ Q k hi' hx' with ⟨s', hs', hxs'⟩ | ⟨-, hsucc'⟩
      ...
      · obtain ⟨e, he⟩ : ∃ e, (Q.classDarts k i)[n + 1]? = some e :=
        ...
        have heq : e = e' := Equiv.injective S.diagram.toCombMap.sigma
          ((Piece04.WindowShape.ClassStep.sigma_succ Q k i j hi hk n x e hx he).trans
            (Piece04.WindowShape.ClassStep.sigma_succ Q k i' j hi' hk' n' x e' hx' he').symm)
        subst heq
        exact ih (n + 1) (n' + 1) e (by omega) he he'

#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.ClassDisjoint.false_of_getElem?
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.ClassDisjoint.disjoint_of_gapOffFace

end GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.ClassDisjoint
