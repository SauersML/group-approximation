...
*GL02 copy.*  Re-proof of the foreign module `Piece04.WindowShape.WindowHeadSplit`
(origin/main blob `884491307`), moved to namespace `Piece04.GL02`.  Its import closure
...
#audit_axioms GroupApproximation.GGT.VanKampen.GreendlingerLeaf.Piece04.GL02.WindowShape.WindowHeadSplit.split
