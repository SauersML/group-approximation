import GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.RoundingTail
import GroupApproximation.Meta.AxiomGuard

/-!
# Lane nm-tww-23, part 5: the floor multiplicities
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.roundLayers

theorem roundLayers_le (N : ℕ) (μ : Y → ℝ) (i : Y) :
    (roundLayers N μ i : ℝ) ≤ (N : ℝ) * μ i ^ 2 :=
  Nat.floor_le (mul_nonneg (Nat.cast_nonneg N) (sq_nonneg (μ i)))

#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.roundLayers_le

theorem lt_roundLayers_add_one (N : ℕ) (μ : Y → ℝ) (i : Y) :
    (N : ℝ) * μ i ^ 2 < (roundLayers N μ i : ℝ) + 1 :=
  Nat.lt_floor_add_one _

#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.lt_roundLayers_add_one
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.sum_roundLayers_le
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.sub_card_le_sum_roundLayers
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.abs_sq_sub_sq_le
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.abs_roundLayers_sub_le
