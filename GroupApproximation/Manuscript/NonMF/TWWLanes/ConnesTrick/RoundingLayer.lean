import GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.Endpoint
import GroupApproximation.Sofic.NormTraceGap
import GroupApproximation.Meta.AxiomGuard

/-!
# Lane nm-tww-23, part 1: entries, trace and products of the layered model
...
* Hence the multiplicative defect of the layered model is, on the diagonal layers,
  ...
  entry of `E_a X (1 - E_a) W E_a` from the proof sketch in `Endpoint.lean`.
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.sum_layerModel_eq
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.trace_layer
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.normTrace_layer
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layerTail
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layer_defect_apply
