...
/-!
# Lane nm-tww-11, part 1: compressions of ucp maps are completely positive
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.sum_sum_sum_comm
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.form_sum_conj
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.conjLinear

theorem conjLinear_apply {m n : Type*} [Fintype m] [Fintype n] (V : Matrix m n ℂ)
    (M : Matrix m m ℂ) : conjLinear V M = Vᴴ * M * V := rfl

#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.conjLinear_apply
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.conjLinear_one
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.ucp_conjLinear_comp
