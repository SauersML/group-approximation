import GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.Diagonalize
import GroupApproximation.Meta.AxiomGuard

/-!
# Lane nm-tww-11, part 4: the layered model of Connes' trick
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layerModel
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layer

theorem layer_apply (c : Y → ℕ) (M : Matrix Y Y ℂ) (p q : layerModel Y c) :
    layer c M p q = if (p.2 : ℕ) = (q.2 : ℕ) then M p.1 q.1 else 0 := rfl

#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layer_apply
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layerVec
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layerModel_eq_iff
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layer_one
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layer_eq_sum_conj
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layerLinear_apply
...
#audit_axioms GroupApproximation.Manuscript.NonMF.TWWLanes.ConnesTrick.layerLinear_comp_ucp
