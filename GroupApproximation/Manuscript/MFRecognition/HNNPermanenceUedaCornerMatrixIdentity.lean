...
/-! # The finite matrix identity defining Ueda's corner projection -/
...
theorem amalgamLeftInclusion_one_zero_eq_matrixUnit
  ...
  change cStarDiagonalTwo
      (((1 : sourceEdgeAlgebra data) : baseAlgebra data))
