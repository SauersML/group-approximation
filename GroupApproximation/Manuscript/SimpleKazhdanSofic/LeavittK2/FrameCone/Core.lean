import GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.UnitAlgebra
import GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.Coordinate
import GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.Comb
...
#audit_axioms GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.combFamily

theorem combFamily_left (j : Fin 4) : (combFamily L).left j = L.wordS (leftCombWord 3 j) := rfl

#audit_axioms GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.combFamily_left

theorem combFamily_right (j : Fin 4) :
    (combFamily L).right j = L.wordT (leftCombWord 3 j) := rfl

#audit_axioms GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.combFamily_right
...
#audit_axioms GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.combPerm_left
...
#audit_axioms
  GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.cycleRange_symm_succ_of_lt
...
#audit_axioms GroupApproximation.Manuscript.SimpleKazhdanSofic.LeavittK2.FrameCone.cone_core
