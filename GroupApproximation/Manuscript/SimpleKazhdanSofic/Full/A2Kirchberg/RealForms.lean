...
/-!
# Realified Frobenius and trace identities (lane A2Kirchberg)

Fork of the never-wired `GroupApproximation/Analysis/KirchbergRealForms.lean`
(the original is untouched).  Used for Kirchberg's theorem, Math. Ann. 299 (1994),
Theorem 1.1 (property (T) and the factorization property give residual finiteness),
cited in table row A2 of `simple_kazhdan_sofic_group.tex` (l.57--60, bibitem l.864--866).
...
namespace GroupApproximation.Full.A2Kirchberg.RealForms
...
end GroupApproximation.Full.A2Kirchberg.RealForms
