...
/-!
# Orthogonal representations on completions (lane A2Kirchberg)

Fork of the never-wired `GroupApproximation/Analysis/KirchbergCompletionRepresentation.lean`
(the original is untouched), for Kirchberg's Theorem 1.1 in table row A2 of
`simple_kazhdan_sofic_group.tex` (l.57--60).
...
namespace GroupApproximation.Full.A2Kirchberg.CompletionRep
...
end GroupApproximation.Full.A2Kirchberg.CompletionRep
