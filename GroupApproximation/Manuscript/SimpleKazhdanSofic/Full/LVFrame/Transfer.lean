...
#audit_axioms GroupApproximation.Full.LVFrame.vecToScalar

/-- `(t_{w_i} x)_i`. -/
def scalarToVec (x : A) : Fin 4 → A := fun i => L.wordT (leftCombWord 3 i) * x

#audit_axioms GroupApproximation.Full.LVFrame.scalarToVec
...
#audit_axioms GroupApproximation.Full.LVFrame.comb_orthogonal

theorem comb_complete :
    ∑ i : Fin 4, L.wordS (leftCombWord 3 i) * L.wordT (leftCombWord 3 i) = 1 :=
  (combFamily L).complete

#audit_axioms GroupApproximation.Full.LVFrame.comb_complete
...
#audit_axioms
  GroupApproximation.Full.LVFrame.vecToScalar_scalarToVec
...
#audit_axioms
  GroupApproximation.Full.LVFrame.comb_matrix_mul_left
...
#audit_axioms GroupApproximation.Full.LVFrame.unit_of_frame
...
#audit_axioms GroupApproximation.Full.LVFrame.frame_of_unit
