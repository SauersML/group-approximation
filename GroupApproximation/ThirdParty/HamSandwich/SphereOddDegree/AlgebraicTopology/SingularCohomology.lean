...
This file builds a **genuine** functorial singular cohomology theory by
dualizing Mathlib's singular chain complex functor. There are no placeholder
definitions and no axioms: every declaration is fully implemented and
build-clean.
