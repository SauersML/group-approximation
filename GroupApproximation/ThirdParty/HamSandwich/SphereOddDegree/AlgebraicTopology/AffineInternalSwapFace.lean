import GroupApproximation.ThirdParty.HamSandwich.SphereOddDegree.AlgebraicTopology.AffineInternalSwapLemmas
...
lemma is independent of the project's exact face-map API. -/
