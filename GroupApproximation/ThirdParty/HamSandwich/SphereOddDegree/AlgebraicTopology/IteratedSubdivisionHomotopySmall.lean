...
Finally we combine with Prompt 17 (`exists_iteratedSubdivision_chain_mem_smallChains`):
...
of the small boundary `z`), which is exactly what Prompts 19–21 require; we do not
