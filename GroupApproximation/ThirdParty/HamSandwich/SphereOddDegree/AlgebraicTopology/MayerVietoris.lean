...
The key consequence used downstream (sphere homology, Prompts 23–24) is the
...
after using the small-simplices quasi-isomorphism of Prompt 21 to replace the
...
Using the small-simplices quasi-isomorphism (Prompt 21) to replace the homology
