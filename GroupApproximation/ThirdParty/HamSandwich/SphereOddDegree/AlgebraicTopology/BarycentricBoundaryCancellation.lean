...
import GroupApproximation.ThirdParty.HamSandwich.SphereOddDegree.AlgebraicTopology.AffineInternalSwapFace
import GroupApproximation.ThirdParty.HamSandwich.SphereOddDegree.AlgebraicTopology.PermSignAdjacentSwap
...
import GroupApproximation.ThirdParty.HamSandwich.SphereOddDegree.AlgebraicTopology.BarycentricFiniteCancellation
import Mathlib
...
theorem toSSetObjEquiv_map_op_naturality (X : TopCat.{0}) (n m : ℕ)
  ...
  intro x
  simp only [TopCat.toSSetObjEquiv, TopCat.toSSet]
  rfl
