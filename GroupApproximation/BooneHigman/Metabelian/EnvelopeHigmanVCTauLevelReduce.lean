...
* `d = 2`, words `≤ 5`: 28992 instances; Hop A 6848, Hop A backwards 448, Hop C 21312,
  left 384.
* `d = 2`, words `≤ 6` (candidate list regenerated by `SP/bh-met-77r/left.py`): 124736
  instances; Hop A 30144, Hop A backwards 960, Hop C 92736, left 896.
* `d = 3`, words `≤ 4`: no equal-level tight instances (vacuous).
For words `≤ 5` all left instances have the shape `A = (a, a' u)` with one-letter `x = a`,
`|y| ∈ {4, 5}` (or the mirror image), and
