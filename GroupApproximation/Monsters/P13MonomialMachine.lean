...
theorem w23_conj_w13 : w23 * w13 * w23⁻¹ = w := by
  have h : w23 * w13 * w23⁻¹ =
      (w23 * x 1 1 * w23⁻¹) * (w23 * x 4 (-1) * w23⁻¹) *
        (w23 * x 1 1 * w23⁻¹) := conj_word w23 _ _ _
...
theorem w13_conj_w23 : w13 * w23 * w13⁻¹ = w⁻¹ := by
  have h : w13 * w23 * w13⁻¹ =
      (w13 * x 3 1 * w13⁻¹) * (w13 * x 5 (-1) * w13⁻¹) *
        (w13 * x 3 1 * w13⁻¹) := conj_word w13 _ _ _
...
theorem w23_mul_w13inv : w23 * w13⁻¹ = w⁻¹ * w23 := by
  calc w23 * w13⁻¹ = w⁻¹ * (w23 * w13) * w13⁻¹ * w23⁻¹ * w23 := by
        calc w23 * w13⁻¹
          ...
          _ = w⁻¹ * (w23 * w13) * w13⁻¹ * w23⁻¹ * w23 := by rw [← w23_mul_w13]
    _ = w⁻¹ * w23 := by group
...
theorem mem_Hpar_of_stab {g : P13}
  ...
  · exfalso
    simpa [repVec, e3] using congrFun hstab 0
  · exfalso
    simpa [repVec, e3] using congrFun hstab 1
  · exfalso
    simpa [repVec, e3] using congrFun hstab 2
  · exfalso
    simpa [repVec, e3] using congrFun hstab 0
  · exfalso
    simpa [repVec, e3] using congrFun hstab 1
