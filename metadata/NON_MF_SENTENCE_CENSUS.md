...
* **`partial`**, line 167 --- By Peter--Weyl separation, every homomorphism from $W_K$ to a compact Hausdorff group also kills $L_K$.
  * compact-target clause uses classical Peter--Weyl
* **`partial`**, line 167 --- Thus precomposition is bijective for compact targets and $\Rad_{\mathrm{Bohr}}(W_K)=L_K$.
