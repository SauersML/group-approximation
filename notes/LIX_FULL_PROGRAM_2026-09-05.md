...
| Chern classes over the graded ring (20:45) | cc-projective: green at 2466 jobs (afefc93e5) — the full graded mod-2 ring with `cup_comm`, `PowerBasis`, `chernClass`; cc-relative's `RelativeDual` green at 8730 |
