...
| `LIXCor4PowersStage` | `Gen.climb_pow_notMem_gauged` (concatenated null-homotopy `concatW`), `Gen.lixLimit_pow_notMem` | two fixes under probe |
...
| `LIXCor4PowersDiagChain` | rank-n chain Γ(X₀, End(𝟏ⁿ⊕𝟏ⁿ)) → M₂(A₀); `diagChainN_sectionBlock`; `diagOne_sphereUnitary_mem` | under probe |
