...
kind: claim
title: The normalizer five-by-seven branch is a three-by-four F4 crossed-product problem
distinct_from:
...
finiteness.  The sole survivor uses one base element and two doubled
normalizer cells, and compresses to three monomials.  A `z`-fixed seven-term
partner compresses to at most four monomials.

For the binary Leavitt unit group this is a `3`-by-at-most-`4` inverse problem
