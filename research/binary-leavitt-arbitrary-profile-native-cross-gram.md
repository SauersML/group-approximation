...
distinct_from:
  ...
  full-moving-hecke-packet-retains-q-kernel-profile: that places all ten generators of the complete Hecke source together with W, M, and J1 in one exact 465-dimensional monomial representation and has Q nonzero but QWQ zero; thus even the complete moving GL5 packet does not descend the p2 bound to Q.
