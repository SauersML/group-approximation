...
distinct_from:
  ...
  fixed-host-outside-sofic-permanence-closure: that applies the closure obstruction to the binary Leavitt unit group and the fixed tester host U; this applies it to the binary and d-ary Leavitt unit groups of the surjunctivity tower, and records that Thompson's V and the Fournier--Facio group carry no known such subgroup.
  gottschalk-counterexamples-lie-outside-the-permanence-closure: that places every finitely presented infinite simple nonsofic group outside the closure generated by the landed operations (O1)-(O7); this applies the FA closure theorem for all extensions, graphs of groups, directed colimits and marked limits to the levels of the Leavitt tower.
artifacts:
