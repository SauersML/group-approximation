---
rg: 2
id: fix-ggt-van-kampen-greendlinger-leaf-p07-inner-pocket-four-block
kind: claim
title: "Fix GroupApproximation.GGT.VanKampen.GreendlingerLeaf.P07InnerPocket.FourBlockStatement: fails through red imports"
---

**OPEN.** Lean module `GroupApproximation/GGT/VanKampen/GreendlingerLeaf/P07InnerPocket/FourBlockStatement.lean` is red on main at 13d4765e1b (trusted batched probe, job direct-b1789850259). It is not in the root closure.
