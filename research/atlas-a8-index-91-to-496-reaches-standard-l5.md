...
distinct_from:
  ...
  atlas-a4-gl5-packet-collision-screen: that screens one relative labeling parity of the standard subgroup class; this proves every A8 subgroup in the sole surviving ambient group belongs to that class before the separate dual screen handles the other parity.
---
...
family is killed by `atlas-a4-gl5-dual-packet-collision-screen`.

At the next arithmetically possible index, 506, the ambient group is `M23`.
Its `A8` subgroup is maximal, has normalizer itself, and forms the ATLAS
degree-506 point-stabilizer class.  This maximal sporadic embedding is the
first carrier not covered by the alternating, symplectic, or linear screens.
