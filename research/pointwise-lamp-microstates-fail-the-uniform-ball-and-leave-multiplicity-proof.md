...
Together with (3) this proves (KUS2). Only the lower bound is needed for the
applicability fence.
...
Theorem 3.5 genuinely applies if (1) is available. Equation (4) then shows
