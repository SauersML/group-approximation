...
must survive outside `K_Z`; extending the construction to the saturated sum
`K_Z^sat` would require orthogonalizing target ranges belonging to different
central Jiang--Su embeddings.
