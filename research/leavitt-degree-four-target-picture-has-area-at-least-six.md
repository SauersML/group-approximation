...
kind: claim
title: A revised degree-four KL picture killing the target commutator has at least six relator vertices
artifacts:
...
coefficient regions are trivial and whose outer boundary is conjugate, by a
corner rotation, to
...
Consequently any such target-killing picture has at least six relator
vertices.
