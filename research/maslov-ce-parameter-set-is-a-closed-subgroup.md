...
Connes embeddability of **every** Maslov-twisted group factor, including the
mod-three Deligne factors.  If the small-twist input fails, `E_CE` is finite
and every parameter outside it gives a non-CE twisted group factor and hence
a countable nonhyperlinear central extension.  Moreover
