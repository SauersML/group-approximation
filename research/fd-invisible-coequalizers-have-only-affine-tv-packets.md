...
(Repair note: the authoring lane's proof route
kt-coequalizer-affine-packet-proof has not landed; the invalid
requires-block and dangling artifact reference were removed to keep
main compiling.  The attack lives in that lane's forthcoming route.)
