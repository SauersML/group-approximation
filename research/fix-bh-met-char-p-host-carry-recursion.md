...
**Module.** `GroupApproximation/BooneHigman/Metabelian/CharPHost/CarryRecursion.lean`. It is red on origin/main at 3c8b417428 with 4 hard errors, from bh-pal-integrate's trusted MSI build
...
**First errors.**
```
    line 99:0: automatically included section variable(s) unused in theorem `GroupApproximation.BooneHigman.Metabelian.CharPHost.carryDigits_nil`:
    line 101:0: automatically included section variable(s) unused in theorem `GroupApproximation.BooneHigman.Metabelian.CharPHost.carryDigits_cons`:
    line 125:0: automatically included section variable(s) unused in theorem `GroupApproximation.BooneHigman.Metabelian.CharPHost.listPoint_nil`:
```
...
**Resolve when.** A trusted build (`gqprobe-lean.sh`) of `GroupApproximation.BooneHigman.Metabelian.CharPHost.CarryRecursion` is green with no errors, and the repaired bytes are on
