...
distinct_from:
  ...
  finite-schreier-holonomy-rounding-criterion: that gives a finite-cycle compatibility criterion for supplied block normalizers; this identifies the remaining cycle data as a representation and separates large exact holonomy from perturbative additive cocycles.
  ...
  collision-and-phase-free-cartan-observables-force-joint-lamp-targets: that extracts point permutations after a common rank-one masa is supplied; this quantifies when canonical mixed traces themselves manufacture a monomial basis inside a fixed finite holonomy fiber.
