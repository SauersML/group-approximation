...
**OPEN.** Lean module `GroupApproximation/GGT/VanKampen/GreendlingerLeaf/P10RosePassages/Rose.lean` is red on main at 9add2d485e (trusted batched probe, Slurm job direct-b1789839564). It is not in the root closure.
