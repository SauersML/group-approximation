...
claim. However,
`local-source-gauge-is-coherent-shadow-reselection` proves that the gauge
claim is quantitatively equivalent to simultaneous coherent geometric
rounding on the same cloud. The route is a useful coordinate reformulation,
not a bypass of the coupled packing/synchronization problem.
