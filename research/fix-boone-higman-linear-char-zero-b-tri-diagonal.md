...
**OPEN.** Lean module `GroupApproximation/BooneHigmanLinear/CharZero/BTri/Diagonal.lean` is red on main at 296aff5838 (trusted batched probe, Slurm job union build b1789837230). It is not in the root closure.
...
**Repair landed, unprobed.** cde42f532e: BTri: fix Building (Connectivity import) and Diagonal (unused section vars, duplicate rewr. Stays OPEN until a trusted probe builds it green.
