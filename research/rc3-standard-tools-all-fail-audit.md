---
rg: 2
id: rc3-standard-tools-all-fail-audit
kind: claim
title: Why the four standard tools each fail to close the RC3 relative-commutant absorption, and the exact residue
artifacts:
  - research/artifacts/hs-dehn-modulus-length-control-2026-08-20.md
distinct_from:
  relative-commutant-collapse-for-sl2-pair: that states the target (RCC/RC3); this is the falsification audit of the obvious attacks on it, recording where each dies so effort is not wasted re-deriving them.
  sl3-pair-relative-commutant-route: that is the higher-rank route and its 1-bounded-entropy handle; this collects ALL four standard attacks and their precise failure points.
---
