...
into either an arbitrary finite von Neumann algebra or a separably acting
semifinite von Neumann algebra, the maps `pi phi` and `pi psi` are
...
after passing to a tracial factor completion, but in every finite shadow and
every separably acting semifinite von Neumann shadow of the pair-generated
algebra.
