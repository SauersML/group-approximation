...
**RESOLVED (516e496a4a, trusted batched probe job direct-b1789910605).** Previously OPEN. Lean module `GroupApproximation/GGT/VanKampen/GreendlingerLeaf/P07InnerPocket/PocketRunArc.lean` failed to build in direct batch b1789850259 (09-19, base 13d4765e1b, empty overlay; union log gq-slurm/batch-b1789850259-all.log). It blocks 11 of the modules touched by the `open scoped List` sweep 9ddeaca04a. Its imports built green, so this is a leaf: its errors are its own.
