...
kind: claim
title: Arbitrarily stratified Z-stable real-rank-zero algebras have generic generators
artifacts:
...
for some ordinal `gamma`, there is an increasing family of ideals
...
The ordinal may be arbitrary; no countability or cofinality hypothesis is
imposed.
