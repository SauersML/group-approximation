---
rg: 2
id: sl-n-z-circle-actions-factor-through-finite-groups-citation
kind: route
title: Import Witte's theorem that finite-index subgroups of SL(n,Z), n >= 3, act on the circle only through finite groups
target: sl-n-z-circle-actions-factor-through-finite-groups
requires: []
---

Citation import, not a reproof. D. Witte, *Arithmetic groups of higher Q-rank
cannot act on 1-manifolds*, Proc. Amer. Math. Soc. 122 (1994), no. 2, 333--340.
...
- K. Parwani, *Actions of SL(n,Z) on homology spheres*, arXiv:math/0504189v1
  ...
  (1994), no. 2, 333–340."
- S. Ye, *Piecewise linear actions and Zimmer's program*, arXiv:1301.6366 (HTML),
  which cites the same paper for the circle case of Zimmer's conjecture for
  arithmetic lattices of Q-rank at least 2.
