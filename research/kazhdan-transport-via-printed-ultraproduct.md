...
What this route adds is that the argument the manuscript actually prints, step
by step, is now machine-checked apart from one construction.
...
`ultraproductKazhdanTransport`: if the conclusion fails there are `gamma_0`,
