...
kind: claim
title: Seventeen hyperbolic trivalent triangle groups tabulated with VTF "?" by Caprace–Conder–Kaluba–Witzel are virtually torsion-free
distinct_from:
  hyperbolic-triangle-of-finite-groups-not-virtually-torsion-free: that asks for a hyperbolic triangle of finite groups with no finite quotient injective on its vertex groups; this exhibits such quotients for seventeen explicit literature members, so none of them is an example
...
- Half-girth type (3,3,4): `G_4^{14,14,48}`, `G_0^{16,16,54}`, `G_0^{16,18,48}`, `G_0^{16,24,48}`,
  `G_2^{16,24,54}`, `G_4^{26,26,48}`.
...
- Sixteen of the homomorphisms are products of epimorphisms onto simple quotients that CCKW already list.
...
cases. The remaining 57 are listed in the artifact with the kernel intersections that no quotient found
removes.
