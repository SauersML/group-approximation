...
for pure `A` it order-embeds the soft subsemigroup.  Any injectivity defect
must involve a nonsoft class; the theorem does not address surjectivity or
assert that every noncompact class is soft.
