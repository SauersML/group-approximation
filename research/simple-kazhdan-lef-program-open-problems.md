---
rg: 2
id: simple-kazhdan-lef-program-open-problems
kind: claim
title: Program root of the open problems the simple Kazhdan LEF groups swarm left, beyond the note's two questions
root: true
distinct_from:
  simple-kazhdan-lef-groups-note-open-questions: that root carries only the two questions the note prints; this root carries the swarm's other open problems about the same groups and their relatives.
---
...
sk-cairn-steward-2, which may extend this conjunction.

## Attempts
- Each member records its own approaches and firewalls in its `## Attempts` section; the sk lanes that own them are
  named there (sk-universal-embedding-a/b, sk-lef-embedding-c/d, sk-sofic-embedding-a/b, sk-wp-embedding,
  sk-general-actions-b, sk-labbe-matricial, sk-stable-rank-a/b, sk-open-1, sk-open-4, sk-generators,
