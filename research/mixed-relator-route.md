...
- a common self-map law on one source-sized paired label space (common-self-map-law),
- synchronized outer transition PVMs on a common carrier (outer-pvm-synchronization), and
- the size-uniform mixed-relator-energy → conditional-variance bound
