...
distinct_from:
  ...
  conjugation-image-of-a-torsion-free-mf-group-is-arbitrary: for non-MF inputs that gives a torsion-free MF group whose normal free abelian subgroup has a strictly larger centralizer, so it refutes only a permanence principle; this is the property that construction lacks for those inputs and the reason it does not reach the transfer.
...
contains a nontrivial free group for non-MF inputs. It is why that
construction refutes a permanence
