...
**OPEN - partially certified (13 of 16 slices); the remaining 3 slices are running.**
...
**Certified so far** (`k5_partial_runs.log`). Slices `i = 0, 1, 2, 3, 4, 5, 6, 7, 10, 11, 12, 13, 14` (13 of 16) print `ALL CLOSED` (slices 3, 4, 5, 10, 13 and 14 added by lane w7-078). Slices `8, 9, 15` are running. Each closed slice took about 28,000–32,000
boxes and 41,000–45,000 SDP solves, in 14 to 26 minutes on one core. The smallest SDP value at any box
