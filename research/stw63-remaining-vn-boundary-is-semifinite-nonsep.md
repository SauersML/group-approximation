---
rg: 2
id: stw63-remaining-vn-boundary-is-semifinite-nonsep
kind: claim
title: The remaining von Neumann boundary is nonseparably acting properly infinite semifinite assembly
artifacts:
...
```text
equal M-rank on Z  =>  norm approximate unitary equivalence in M.
```

This is a reduction, not a claim that the implication is known.  Arbitrary
central integration cannot simply invoke standard-Borel measurable
selection, and no such selection is used here.
