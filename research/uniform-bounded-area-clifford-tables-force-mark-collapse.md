...
distinct_from:
  ...
  fixed-mark-forbids-uniform-clifford-table-area: that proves the hypothesis below cannot occur for a nontrivial fixed finite mark in any finitely presented group; the conditional analytic implication here remains valid but is vacuous as a construction route.
artifacts:
