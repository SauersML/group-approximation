...
3. So `G` is bounded in the sense of Burago–Ivanov–Polterovich (every conjugation-invariant norm is bounded) iff `λ^c` is bounded. That is the open claim `subshift-el-groups-have-bounded-conjugation-invariant-norms`.
