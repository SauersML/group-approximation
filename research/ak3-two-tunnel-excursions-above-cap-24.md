...
kind: claim
title: Excursions above length 24 with two AC products through a Whitehead-minimal point of length 25–26 enlarge the AK(3) tunnel-closed component but reach no goal; from the tunnel-only states they close after 5 rounds at 263067 classes (rank 2)
distinct_from:
...
Chaining more than two AC products inside the band (k-tunnels, `band.sh`) keeps finding new
landings. From the 14299 classes of the third level, the first band round adds 124 states,
still with no goal. This is recorded as running, not claimed.
