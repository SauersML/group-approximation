...
**Machine-checked.**  `Computability/ProfinitelyClosedIndexSet.pi03Complete_closedIndex` is this theorem: `Pi03` membership via `closedIndex_iff_forall_index`, and `Pi03Hard` via the dyadic rows.
