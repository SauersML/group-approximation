...
**RESOLVED (d2df12ed90).** Lean module `GroupApproximation/BooneHigman/Metabelian/ElemFPK2StabDiagEndpoint.lean` failed to build on main (trusted MSI build of origin/main 3c8b417428, 09-18; 3 error lines).
