...
the manuscript's literal group `EL_12(R)`.  The independent
`property-t-free-torsion-free-full-mf-radical` supplies the second main
theorem with its Property-`(T)` clause removed.  The remainder is algebraic
assembly.
