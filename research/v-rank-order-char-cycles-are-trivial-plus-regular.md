...
*Verification by `w3-vf-linear` (2026-09-12), §33.3 of `research/artifacts/w3-vf-linear-verification-2026-09-12.md`: PASS on the w7-v-cycle-c3 entry "Next test for p >= 3": the profiles, coherence, mixtures and the broken wreath premise all re-derive. Its conclusion concerns elementary abelian p-group data only.*
