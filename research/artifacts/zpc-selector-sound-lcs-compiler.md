# Perfect-strategy ZPC-to-LCS compiler (superseded target)

Former Cairn claim `zpc-selector-sound-lcs-compiler`, demoted because sound
decoding only at attained perfect strategies cannot provide the strict
finite-dimensional quantum-value gap needed for nonhyperlinearity.  The live
successor is the quantitatively robust compiler.
