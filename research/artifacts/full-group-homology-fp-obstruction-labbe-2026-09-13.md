...
- Over `Z` the degree-2 argument bounds only the rank. Every finitely generated subgroup of
  `H^2(Z^2; C(X, Z))` lies in a subgroup generated by `N_{3,3}` classes. Integral `H^2` need not be
  finitely generated: for the Thue–Morse square `X_TM × X_TM`, Künneth gives
  `H^2 ≅ K^0(X_TM) ⊗ K^0(X_TM)`, which is not finitely generated. (Review correction,
  `research/artifacts/ex-review-groups-2026-09-12-part17.md`, §17.3: an earlier version of this
  remark claimed finite generation.)
