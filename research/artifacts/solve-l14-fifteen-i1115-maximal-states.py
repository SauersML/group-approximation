#!/usr/bin/env python3
"""Exact all-maximal carrier states for fifteen-winner inverse I(1;115)."""
...
C = load("fifteen_i1115_compression",
         "compress-l14-fifteen-i1115-projections.py")
P, ALG = BASE.P, BASE.ALG


def solver(branch):
    free = (("q", "r", "t", "u", "c") if branch == "I" else
            ("q", "r", "s", "u", "c"))
