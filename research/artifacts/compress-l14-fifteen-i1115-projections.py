#!/usr/bin/env python3
"""Substitute copy retractions and exact R2 branches in inverse I(1;115)."""
...
COMPILER = Path(__file__).with_name("compile-l14-fifteen-i1115.py")
SPEC = spec_from_file_location("compile_l14_fifteen_i1115", COMPILER)
