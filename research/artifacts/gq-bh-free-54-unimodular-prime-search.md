# Prime unimodular dissections of the standard cone in R^3: search script and raw output

This artifact supports Attempt 2 of `unimodular-dissection-operad-has-finite-type`.
Lane bh-free-54, 2026-09-18. It ran on MSI (acn112) on a few cores for a few
minutes; nothing was run locally.

## How it works

- **Primality test.** A dissection is prime if no set of at least 2 but not all
  pieces has union a unimodular cone. The test is exact, by part 3 of
  `unimodular-dissections-have-egyptian-fraction-volumes`:
  - candidate cones are those whose sides run along piece edges;
  - a candidate is a union of pieces when its weight equals the summed weights of
    the pieces inside it.
- **Checks.** Every generated configuration is asserted to be unimodular with
  weight sum 1. The sanity run confirms that `E`, `Z` and `M` are prime and that
  the barycentric `B_6` has 9 mergeable proper sets.
- **Scope.**
  - `bfs` is exhaustive only over configurations reachable by local moves through
    configurations with at most one more piece.
  - `anneal` and `seeded` are random searches.

## Raw summaries

```
== bfs_fan9.out
{"mode": "bfs", "kind": "fan", "maxn": 9, "reach": 10, "complete_within_reach": true, "secs": 126.7, "count_by_size": {"1": 1, "2": 1, "3": 3, "4": 11, "5": 46, "6": 217, "7": 1013, "8": 4920, "9": 23967}, "primes_by_size": {"2": 1, "3": 1, "6": 2, "9": 8}}
== bfs_dis7.out
{"mode": "bfs", "kind": "dis", "maxn": 7, "reach": 8, "complete_within_reach": true, "secs": 101.8, "count_by_size": {"1": 1, "2": 1, "3": 4, "4": 26, "5": 214, "6": 1969, "7": 18959}, "primes_by_size": {"2": 1, "3": 1, "6": 4}}
== ann4.out
{"mode": "anneal", "lo": 10, "hi": 18, "seed": 4, "steps": 153061, "prime_fans_by_size": {"9": 3, "11": 5}}
== ann5.out
{"mode": "anneal", "lo": 15, "hi": 26, "seed": 5, "steps": 81295, "prime_fans_by_size": {}}
{"mode": "anneal", "lo": 8, "hi": 14, "seed": 1, "steps": 114462, "prime_fans_by_size": {"9": 5, "10": 4}}
{"mode": "anneal", "lo": 14, "hi": 22, "seed": 2, "steps": 53112, "prime_fans_by_size": {"14": 1}}
{"mode": "anneal", "lo": 22, "hi": 34, "seed": 3, "steps": 24624, "prime_fans_by_size": {}}
```
