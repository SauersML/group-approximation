...
| Simplicity over any field | Clark–Edie-Michell, arXiv:1403.4684, §4, corollary `thm:feild`: "$A_R(G)$ is simple if and only if $G$ is effective and minimal, and $R$ is a field"; Steinberg, arXiv:1408.6014, §3, corollary `simplehaus` | e-print source; statement numbers not read from the PDFs |
