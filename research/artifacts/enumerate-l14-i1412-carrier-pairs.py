...
Its inputs are generated by the globally minimum-block screens.  Independent
all-maximal forest jobs 16679815 and 16679829 prove, for these two exact color
words, that every coarsening-maximal partition has that minimum block count;
the intersection is therefore exhaustive here.
"""
