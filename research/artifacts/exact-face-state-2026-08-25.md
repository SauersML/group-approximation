...
## 4c. The involution route: outlier confinement and the restricted leaf
...
by weak ucp-stability, with no converse or strict separation proved.
Two fences protect it: free involutions have squared additive commutator
norm `2` with their twists, so abelian-carried leaks (wreath coordinates, K-orbit cells)
