...
| char 0 linear | GL_n(Z) (Scott 1984); f.g. subgroups of GL_n(Q), including S-arithmetic groups in char 0 (Zaremsky Thm 1.2, Example 4.7 criterion); virtually polycyclic groups and everything virtually in a RAAG (survey Thm 5.1). Open: f.g. subgroups of GL_n over number fields or function fields of char 0. |
