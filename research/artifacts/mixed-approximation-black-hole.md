# A finitely presented mixed sofic/MF approximation black hole

Former Cairn claim `mixed-approximation-black-hole`, demoted because its own
audit marks the literature inputs unverified and its conclusion outside the
active roots.  The conditional proposal is preserved below.
