#!/usr/bin/env python3
"""Substitute copy retractions and the two exact R2 branches in I(0;124)."""
...
COMPILER = Path(__file__).with_name("compile-l14-fifteen-i0124.py")
SPEC = spec_from_file_location("compile_l14_fifteen_i0124", COMPILER)
