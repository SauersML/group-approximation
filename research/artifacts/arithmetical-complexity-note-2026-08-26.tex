...
\item \path{TrivialEnumeratedPi02.trivial_enum_pi02Complete}, \path{AbelianEnumeratedPi02.comm_enum_pi02Complete}, \path{PerfectEnumeratedPi02.perfect_enum_pi02Complete}: triviality, commutativity and perfectness as exact $\Pizt$-completeness on enumerated presentation codes (perfectness through commutator-product words evaluated by the uniform word-problem checker).
