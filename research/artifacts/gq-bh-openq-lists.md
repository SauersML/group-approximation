...
## H. Fifth pass (09-18 afternoon): Kourovka v46, the Grigorchuk RF-host question, priority checks

**Method.**
- Full TeX of the Kourovka Notebook arXiv:1401.0300v46 (1 September 2026) was searched. Issue 21 has 150
  problems, and we grepped all of them for BH-adjacent terms.
- Also searched: Grigorchuk's survey *Solved and unsolved problems around one group* (all numbered problems),
  Bartholdi–Grigorchuk–Šunić *Branch groups* (all `question` environments), Rauzy arXiv:2002.02540 and
  arXiv:2002.02541, Kochloukova–de Sousa Luiz arXiv:2509.05798, and van Doorn–Judin–Monticone–Morrison
  arXiv:2607.17477.

| # | Question (source) | Node | Status |
|---|---|---|---|
| H1 | Does the Grigorchuk group embed in an fp RF group? | `grigorchuk-group-embeds-in-fp-residually-finite-group` | OPEN. **Not a named problem** (sources above). It is the first test case of Rauzy's printed question (arXiv:2002.02540v2): is being recursively presented and effectively residually finite sufficient for embedding in an fp RF group? |
| H2 | Kourovka 21.41 (Dantas–Sidki): a torsion-free fp metabelian self-similar group containing Z wr Z? | `torsion-free-fp-metabelian-self-similar-group-contains-z-wr-z` (new) | OPEN. Kochloukova–Luiz conjecture NO. Baumslag's group is excluded by them and by main; affine witnesses are excluded by a lane lemma (Z wr Z is linear over no global field) |
| H3 | Priority: `baumslag-char-zero-metabelian-group-is-not-self-similar` (main, 09-12) | same node | Prior literature added: Kochloukova–Luiz arXiv:2509.05798, Examples item 2 (September 2025) |

**Priority check: arXiv:2607.17477** (van Doorn, Judin, Monticone, Morrison; v1 20 July 2026, v2 26 July 2026).
- It claims eight Kourovka problems: 3.46, 18.50, 19.25, 20.125, 21.8, 21.24, 21.147 and 21.150.
- None of them is one we answer. Ours are 17.57, 17.59, 17.60, 17.61, 21.73, 21.74(b),(c) and 21.75, with
  21.74(a) in part, 5.15 a literature answer, and 14.10(c) in the gq summary.
- The only topical neighbor is 21.8. They prove that the group generated by horizontal class transpositions of
  modulus at most k is S_{lcm(2..k)} for k ≥ 4, and Pan proved the same independently. That is a statement
  about finite quotients of CT(Z). It neither implies nor conflicts with our CT_P(Z) results, and our 21.75
  node already cites the paper.

**Kourovka issue 21, BH-adjacent and not on main, recorded without a node:**
- 21.140 (Witzel–Zaremsky): must a torsion-free F_∞ group of infinite cd contain Thompson's F?
- 21.39 (Dantas–de Melo): a locally finite, characteristically simple, non-RF group with finitely many
  Aut-orbits?
- 21.143, 21.144 and 21.145 (Thompson's F: automatic? Brin–Sapir conjecture? F QI to F×Z or F×F?)

**Lesson for general BH (this pass).** Branch groups are easy for BH and hard for residually finite hosts. The
L-presentation endomorphism is realized for free in V-type hosts by the prefix shift, and it is forbidden in
every RF host. So routes to BBMZ 5.3(12) must not factor through an fp RF overgroup of a branch group. Similarly,
