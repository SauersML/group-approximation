...
\[
 K_i\in M_d(\mathbb Q(i)),\qquad K_i^*=-K_i.
\]
...
\[
 \|V-I\|_{2,d}^2=2-2\operatorname{Re}\operatorname{tr}_d(V). \tag{CHP4}
\]
...
\[
 \mu_{\Gamma,W}(n,q)
   =\max\{d(i,j):1\le i\le n,\ 1\le j\le q\}.             \tag{CHP5}
\]
...
For \(g,h,gh\in B_R\), choose representative words of length at most \(R\).
Then
