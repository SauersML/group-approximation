...
**ESTABLISHED** by `fg-q-rings-have-no-matrix-representations-proof` (lane proof, not independently
...
- **Rings exhausted by locally matricial pieces.** If a ring `S` is a union of unital subrings, each of which
