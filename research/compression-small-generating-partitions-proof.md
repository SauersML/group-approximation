---
rg: 2
id: compression-small-generating-partitions-proof
kind: route
title: Read the code's time-zero partition, or take the name map of a generating partition
target: compression-codes-are-small-generating-partitions
requires: []
artifacts:
...
* **Code to partition.** Proposition 1 of the compression artifact: the time-zero partition of the code
  is generating, by Lusin–Souslin.
