...
holds on the regular sector of exact BS skeletons.  Direct sums with
`L->infinity` give a diffuse/ultraproduct version: eigenvalue one lies in the
approximate spectrum on the orthogonal complement of the fixed algebra.
