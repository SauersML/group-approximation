...
This is a literal finite presentation after adjoining the two displayed
matrix words to any standard finite presentation of `SL_3(Z)`.  Since
`r notin <a,b>`, Britton gives `w_exp != 1`.
