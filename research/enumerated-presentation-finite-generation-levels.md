...
**Machine-checked lower bound.**  The second-level lower bound for `T_enum` is `IsoInvariantSwitchHardness.kazhdanCode_pi02Hard`; the third level is the cofiniteness encoding above, paper-level.
