...
**RESOLVED (2d6ebaf55).** Lean module `GroupApproximation/BooneHigman/Metabelian/EnvelopeGenTorsionNakayama.lean` failed to build on main (trusted MSI build of origin/main 3c8b417428, 09-18; 2 error lines).
