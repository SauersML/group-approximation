...
* **Ozawa's Kazhdan-projection construction** (arXiv:2609.08892, imported as
  ...
  The surviving form of this attack is the open certificate
  `nuclear-factor-with-infinite-mf-tensor-exists`, routed into this claim by
  `nuclear-non-uct-via-infinite-mf-tensor`.  It reduces here to whether the
  algebra generated by the block representation of `SL(3,Z)` is exact.
