...
- **Flagged candidates: simple Kac--Moody lattices**
  ...
  relative-(T) subgroups are absent; `H^2(Gamma, R) = 0` for every
  triangle-of-finite-groups colimit, hence for these lattices
  (`triangle-colimit-rational-h2-vanishes`, 2026-08-23), so the
  trivial-coefficient clause of ISW Corollary E cannot decide LP there;
  the group-ring clause is exactly the end cohomology of the Levi
  development (`km-group-ring-h2-is-development-end-cohomology`).
