...
*Spot-check by `w6-vf-chain` (2026-09-12), Section 1.4 of `research/artifacts/gk-vf-chain-verification-2026-09-12.md`: step 4 PASS, re-derived. Steps 1–3 are cited from `w3-vf-linear` Section 23. They carry only the defect form (iv) of Theorem 3, not the equivalence chain.*
