...
```text
1,p,p^(-1),q,r,r^(-1),a,e,c,b,d
```

is a solution of `W'=1` inside the Leavitt elementary group.  Each failure
has an explicit moved basis vector in the faithful infinite-word module.
