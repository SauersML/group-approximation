---
rg: 2
id: finite-bi-index-site-coherence-from-stable-kazhdan-pair
kind: route
title: Supply a stable acting group and project the lamp onto its Kazhdan stabilizer commutant
target: uniform-hs-site-coherence-for-finite-bi-index-pair
requires:
...
exactifies its acting tuple and Reynolds-rounds the lamp into the stabilizer
