---
rg: 2
id: doubling-quotient-residually-finite
kind: claim
title: Residual finiteness of the abelianized-lamp doubling quotient
distinct_from:
...
the quotient K_ab^(Z) x| G is residually finite: G embeds in GL4(Z[1/2])
(odd-prime congruence separation), and the quotient embeds in
G x (K_ab wr Z) via the height homomorphism.
