...
distinct_from:
  finite-overgroup-packing-preserves-hyperlinearity: that proves the permanence fence; this combines it with the packing contradiction and identifies the base, rather than the auxiliary amalgam, as the actual witness.
