---
rg: 2
id: fix-bhmet-suslin-r1-int-endpoint
kind: claim
...
```
error: GroupApproximation/BooneHigman/Metabelian/SuslinR1IntEndpoint.lean:32:4: failed to compile definition, consider marking it as 'noncomputable' because it depends on 'Polynomial.semiring', which is 'noncomputable'
```

**What it needs.** Make `GroupApproximation.BooneHigman.Metabelian.SuslinR1IntEndpoint` compile under the repository settings without changing any statement.
