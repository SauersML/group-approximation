...
coefficients lie in `B_-=F_2<q,T>`. Thus each collected two-carrier
product, after adjoining arbitrary `g_2` conditioning, lies in a
finitely generated subgroup of `GL_28(B_-)` and has the established
residually finite one-orientation models. This does not assert residual
finiteness of the group generated by both uncollected carriers.
