...
**2026-09-20 conditional connection.** The refuter is the ALL-TRACE
normalization theorem, not nonhyperlinearity of one wreath. Its proposed
analytic input is Jihao Liu, [*Nonhyperlinear groups exist*](https://jihaoliu.org/ai-results/nonhyperlinear-groups-exist-2026-09-20.pdf),
Theorem 1.2/6.7, with the conditional normalization implication credited to
Andreas Thom (and Liu Theorem 7.4). A CE witness reduces to the separable
algebra generated by the group and one noncommuting witness. Embed it in a
matrix ultraproduct; normalization there restricts back by intersecting its
commutant with this invariant subalgebra, a contradiction. The refuter remains
OPEN while the analytic imports are under review; this is not a current
refutation of this node.
