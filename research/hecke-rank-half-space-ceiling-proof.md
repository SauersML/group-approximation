...
\(\operatorname{Tr}(Q R_ZQ)\leq\operatorname{Tr}(R_Z)\), so every feasible
dual point has \(\tau(Z)\geq\operatorname{rank}(Q)/\dim D\). Strong duality
