...
**RESOLVED (a39af618f3, trusted batched probe job direct-b1789834028).** Previously OPEN. Lean module `GroupApproximation/BooneHigman/Metabelian/AffineFPModel.lean` fails to build on main (trusted MSI build of origin/main 3c8b417428, 09-18; 8 error lines).
