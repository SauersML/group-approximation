...
4. **No rational cohomological obstruction to a virtual section.**
   ...
   - **Decided (09-18, lane bh-outfn): it dies.**
     ...
     integral, obstructs a virtual section. What remains is whether the
     extension of that finite-index subgroup by `[F_n, F_n]` virtually splits,
     which is the nonabelian question.
