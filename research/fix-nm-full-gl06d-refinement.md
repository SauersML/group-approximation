...
**OPEN.** Lean module `GroupApproximation/Manuscript/NonMF/Full/GL06d/Refinement.lean` is red on main at 296aff5838 (trusted batched probe, Slurm job union build b1789837230). It IS in the root closure: the root build is red until it is fixed (top priority).
