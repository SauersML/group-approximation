---
rg: 2
id: s3-radical-return-via-common-symplectic-reset
kind: route
title: Merge the S3 chart types on a common symplectic subgroup and renew selectors
target: s3-radical-chart-returns-to-fresh-context
requires:
...
Restrict each of the three conjugate crossed-product charts to its common
symplectic reset subgroup.  The two orthogonal chart blocks then become two
