...
**RESOLVED (9add2d485e, trusted batched probe job direct-b1789839564).** Previously OPEN. Lean module `GroupApproximation/BooneHigman/Metabelian/EnvelopeHigmanVCTauHopF2Cand.lean` is red on main at 296aff5838 (trusted batched probe, Slurm job union build b1789837230). It is not in the root closure.
