...
distinct_from:
  ...
  leavitt-paired-quotient-passes-relative-weight-test: That later global picture argument answers the remaining question negatively and fences this candidate.
artifacts:
...
the generic small-length theory.  The remaining question is now answered by
`leavitt-paired-quotient-passes-relative-weight-test`: the two torsion folds
