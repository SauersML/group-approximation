...
positive characteristic, `ARR` was the claim
`amplified-algebraic-roots-for-nonsingular-equations`. It is refuted in every odd
characteristic by `amplified-roots-fail-in-odd-characteristic`, so this transfer
is vacuous over fields of odd characteristic; the characteristic-zero case is
`amplified-algebraic-roots-in-characteristic-zero` (OPEN). Exact roots in
