...
**OPEN.** Lean module `GroupApproximation/GGT/VanKampen/GreendlingerLeaf/P01CellJunctionValue/Pocket.lean` is red on main at 296aff5838 (trusted batched probe, Slurm job union build b1789837230). It is not in the root closure.
