---
rg: 2
id: fix-bhmet-suslin-normal-lemma
kind: claim
title: "Fix GroupApproximation.BooneHigman.Metabelian.SuslinNormalLemma: unresolved `Pi.single` codomain in `suslinNormal_decomposition`"
---
...
```
error: GroupApproximation/BooneHigman/Metabelian/SuslinNormalLemma.lean:57:34: Type mismatch
```
