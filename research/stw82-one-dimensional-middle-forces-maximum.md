...
kind: claim
title: Every extension inside a nuclear-dimension-one algebra obeys the maximum formula
distinct_from:
...
Let, without any separability hypothesis,

```text
0 -> I -> E -> D -> 0
```

be an extension of C*-algebras.  If
...
Equivalently, every ideal--quotient decomposition of an algebra of
