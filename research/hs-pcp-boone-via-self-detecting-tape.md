...
one-sided Amitsur--Levitzki sequence forces a fixed defect proportional to the
quaternion mark at the finite multiplicity index, while its two-unitary
Halmos--Fock model supplies one bounded infinite realization of every
nontriggered positive instruction.
