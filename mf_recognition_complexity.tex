...
\begin{abstract}
We find that the MF property is very hard to detect from a finite
presentation.  Specifically, the finite presentations of MF groups form a
$\Pi^0_2$-complete set and the finite presentations of non-MF groups a
$\Sigma^0_2$-complete set, so neither is recursively enumerable, and MF
recognition is undecidable even relative to an oracle for the halting
problem.  Here a countable group is MF if it admits finite-dimensional
