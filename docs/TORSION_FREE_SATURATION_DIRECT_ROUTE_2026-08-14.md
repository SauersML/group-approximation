...
`docs/TORSION_FREE_NORMAL_GENERATION_HULL_QUOTIENT.md` (the substitution
route, with verbatim source quotations of every Hull/Osin statement used
here) and `docs/TORSION_FREE_FULL_CDE_MF_FORMALIZATION.md` (the Lean
...
by axioms.  See `docs/TORSION_FREE_FULL_CDE_MF_FORMALIZATION.md`.
