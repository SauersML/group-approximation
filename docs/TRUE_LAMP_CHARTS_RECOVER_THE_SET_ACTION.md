...
`docs/NOTEPAD.md` (section "The 2026 sofic-action permanence theorem cannot
...
2. **Changing the target class does not help.**  This is the point of
   `docs/FALSE_HALO_ACTION_AUDIT.md`: by its locally-sofic collapse theorem
...
3. **Circularity hazard, stated precisely.**  A programme that keeps
   ...
   requirement recorded at `docs/NOTEPAD.md` line 5891, and it is where the
...
* `docs/NOTEPAD.md`, "single lamps recover the set action" (proof
  transcribed there), and line 5891 for the non-Cartan requirement.
* `docs/FALSE_HALO_ACTION_AUDIT.md`, `(HAA3)`--`(HAA5)`.
