...
`[Gamma:t Gamma t^(-1)]=infinity` (`docs/NOTEPAD.md`, "The compressor has
...
index `[Gamma:t Gamma t^(-1)]=infinity` of `docs/NOTEPAD.md`.  That is a
...
`docs/CREDIT_AND_PRIORITY_AUDIT.md`.)  That question sits directly under
...
* V. Alekseev and A. Thom, *Centralizers of sofic approximations of Kazhdan
  ...
  against the full text in `docs/CREDIT_AND_PRIORITY_AUDIT.md`.
...
* In-repo: `TRUE_KUN_THOM_CLIFFORD_PHASE.md`,
  ...
  `docs/NOTEPAD.md` ("The compressor has infinite index"),
