...
group** `C(X)` (`docs/NOTEPAD.md` ~20385) has generators `z`, `a_x` (`x ∈ X`)
and relations
...
information whatsoever. At the other end, `docs/PERFECT_CORE_KUN_THOM_WREATH.md`
...
- `docs/TRUE_BLOCK_MONOMIAL_COORDINATE_COLLAPSE.md` — the abelian theorem and
  Lemma 1.
- G. Kun and A. Thom, arXiv:2608.06222v1, Theorems A and E; verbatim in
  `research/artifacts/kun-thom-2608-06222-verified.md`.
- `docs/NOTEPAD.md` ~20385 for `C(X)` and the central-quotient identification;
  `docs/PERFECT_CORE_KUN_THOM_WREATH.md` Theorem 1 for `[A,G] = I_X`.
