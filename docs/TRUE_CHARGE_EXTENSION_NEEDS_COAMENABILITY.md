...
of `docs/FALSE_POSITIVE_CORE_IS_SOFIC.md` with `X₀ = TΓ/Γ`, `T = ΓL₊`,
`L₊ = SL_d(ℤ) ∩ M_d(ℕ)`.
...
This is the same fact `docs/OBSTRUCTIONS.md` §3 records as "`G ↷ G/Γ` has no
...
- `docs/FALSE_POSITIVE_CORE_IS_SOFIC.md`, `docs/OBSTRUCTIONS.md` §1 and §3.
