...
`docs/TRUE_DIAGONAL_NORMALIZER_RIGIDITY.md`, Lemma 3, shows
...
argument already in `docs/NOTEPAD.md`: a Definition-4.23 chart system for the
...
form of the target obtained in `docs/TRUE_DIAGONAL_NORMALIZER_RIGIDITY.md`,
Corollary 8:
