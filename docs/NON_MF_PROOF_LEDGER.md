...
| thm:sign-criterion | env | thm:sign-criterion | 50daf8a96c218a8b |
...
| p:conj-two-element | prose | `there the average is` | - |
...
| p:A-defect-square | prose | `the marked word is a defect square` | - |
