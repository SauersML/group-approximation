...
/-!
# Dump the Boone–Higman megasubmission statements and their declaration closures (Challenge side)

The twin of `scripts/PalomarBooneHigmanSolutionType.lean`, modeled on
...
Run with `scripts/remote-build.sh --run scripts/PalomarBooneHigmanChallengeType.lean`.
-/
...
#eval show MetaM Unit from do
  let targets : List (Bool × Name) :=
    [(true,  `BooneHigman.IsMetabelianGroup),
     ...
     (true,  `BooneHigman.integerReflection),
     ...
     (true,  `BooneHigman.GraphProduct),
     (false, `BooneHigman.explicit_fp_overgroup_of_all_gl_n_q),
     (false, `BooneHigman.finitely_presented_metabelian_embeds_in_finitely_presented_simple),
     (false, `BooneHigman.finitely_generated_metabelian_embeds_in_finitely_presented_simple),
     (false, `BooneHigman.finitely_generated_linear_embeds_in_finitely_presented_simple),
     (false, `BooneHigman.finitely_generated_linear_embeds_in_finitely_presented_self_similar),
     (false, `BooneHigman.kourovka_17_57),
     (false, `BooneHigman.kourovka_17_59),
     (false, `BooneHigman.kourovka_17_60),
     (false, `BooneHigman.kourovka_17_61),
     (false, `BooneHigman.kourovka_21_75),
     (false, `BooneHigman.kohl_factorization_conjecture),
     (false, `BooneHigman.graph_product_embeds_in_type_a_group),
     (false, `BooneHigman.exists_fp_simple_with_mixed_identities_not_finitely_normally_generated)]
  let env ← getEnv
