...
FORBIDDEN_ALLOWLIST = {
    ...
    # Palomar/SurjunctiveNonsoficChallenge.lean states its two theorems the same way.
    ("sorry / sorryAx", "Palomar/SurjunctiveNonsoficChallenge.lean", 111, "sorry"),
    ("sorry / sorryAx", "Palomar/SurjunctiveNonsoficChallenge.lean", 118, "sorry"),
}
