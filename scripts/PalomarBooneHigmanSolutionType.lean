...
/-!
# Dump the Boone–Higman stage 1 statements and their declaration closures (Solution side)

The solution-side driver for `Palomar/comparator-boone-higman.json`, twin of
`scripts/PalomarBooneHigmanChallengeType.lean` and modeled on
...
Run with `lake env lean scripts/PalomarBooneHigmanSolutionType.lean`.
-/
