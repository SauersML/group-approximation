...
The challenge-side driver for `Palomar/comparator-stw-x1.json`, twin of
`scripts/PalomarSTWProblemX1SolutionType.lean`.
...
Run with `lake env lean scripts/PalomarSTWProblemX1ChallengeType.lean`.
-/
