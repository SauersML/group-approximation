...
# and `STWProblemXXII` for the submittable pairs, and `LIXStrong` for the
# pending one.  Every pair is run
...
for prefix in "" LIX BowenChapman Pestov91 TypeA2 GubaThompson GKPCommutingActions STWProblemX1 STWProblemXXII; do
