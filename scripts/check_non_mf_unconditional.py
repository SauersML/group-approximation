...
DEFAULT_INVENTORY = REPO / "docs" / "NON_MF_CONDITIONAL_INVENTORY.md"
DEFAULT_BASELINE = REPO / "docs" / "NON_MF_UNCONDITIONAL_BASELINE.txt"
...
def render_baseline(
    ...
    header = (
        ...
        "# Every line must correspond to a row of docs/NON_MF_CONDITIONAL_INVENTORY.md.\n"
        "# Regenerate with:\n"
        "#\n"
...
def main() -> int:
    ...
    if new or problems:
        ...
        if counts:
            ...
            print(f"  ({summary}; see docs/NON_MF_CONDITIONAL_INVENTORY.md. "
