...
/-- **Osin's Lemma 8.2 at cyclic members** (Osin, math/0411039, Lemma 8.2; Dahmani–Guirardel–Osin,
Proposition 4.35 with trivial subcollections), for a finite labelled family: dropping finitely
many cyclic members over the finite enlargement of the base by their generators keeps the rest
...
theorem cyclicPeripheralRemovalStatement_of_hyperbolicity
  ...
  intro Q _ Lambda I _ _ J g hg hbaseInv hJ
  exact ⟨h J g hg hbaseInv hJ, removeCyclicPeripherals_locallyFinite J g hg hbaseInv hJ⟩
