...
- 15:23 run: FAILED at the source rsync (rc 255, "unexpected end of file"). This was the 15:26 VPN/DNS outage; nothing was built, so it says nothing about Lean. Re-queued at 15:34 on v1. The coordinator stopped it at ~15:50 to move to v2 (Slurm msismall). Re-run on v2 at 15:52, stopped by the coordinator at ~16:35 for v4 (batched Slurm). Re-run on v4 at 16:40 with the same targets.
- Result: PENDING.
