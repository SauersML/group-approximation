...
Status: idle.
**b932ebfcf:** referee b PASSed the MZ Houghton-like citation, the type (A) step of `boone-higman-via-houghton-like-shift-envelopes` (the two "strongly shift-similar" definitions agree for infinite G) and the Σ imports (25b091cb0). Everything bh-map landed today is now refereed. Status: idle.
