...
# targets at it: landed SurjunctiveNonsofic / Dynamics / campaign KunThom, Kazhdan and Sofic modules, plus every
# GroupApproximation module imported by the integrated Palomar checks, plus the Palomar libs.
set -u
