...
* `kourovka_17_60`: Kourovka Notebook Problem 17.60 (S. Kohl). Are the groups `CT_P(ℤ)`, for
  sets `P` of odd primes, pairwise non-isomorphic? The answer is yes, for finite and infinite `P`.
