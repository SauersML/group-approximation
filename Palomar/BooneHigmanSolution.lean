...
Kourovka 14.10(c) [R], Kourovka 17.59 [IC], Kohl's factorization conjecture [R].
...
vanishing of stable `K₂` of polynomial rings over `𝔽_p`. Kourovka 21.75 and BFFHZ Question 3.3
join stage 1 when their proofs close. BFFHZ Question 3.1 and Kourovka 17.57, 17.60 and 17.61 are
out until the developments they need (twisted Brin–Thompson groups, Matui's and Rubin's spatial
realization, Adamczewski–Bell, a finite presentation of `CT_P(ℤ)`) exist.
