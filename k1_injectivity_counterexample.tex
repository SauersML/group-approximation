...
\begin{document}
\begin{abstract}
We answer Problem LIX of Schafhauser, Tikuisis and White: there is a unital
simple separable C*-algebra $A$ and a unitary $v \in \U(A)$ with
...
ask, as Problem LIX of their list \cite{STW}, whether every unital simple
C*-algebra is $K_1$-injective.  The answer is no.
