...
## 31. w6-v-extend: lifts of the transvection (artifact Sections 1–2)
...
### 31.1 Reduction (artifact Section 1). PASS
...
### 31.2 Haar values and the evaluation lift (2.1–2.2). PASS
...
### 31.3 Fock lift and splitting (2.3–2.4). PASS
