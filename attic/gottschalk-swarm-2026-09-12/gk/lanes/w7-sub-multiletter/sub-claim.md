...
- **Multi-letter relation systems (w7-sub-multiletter, 2026-09-12): three firewalls, no deficit.** Artifact
  ...
  * **One-chart coefficients.**
    ...
    - So the coefficient-root escape of the previous entries is sofic data when its coefficients come from one chart.
      Coefficients from both charts lead to `EL_3(J)` (w7-el3j-sofic).
