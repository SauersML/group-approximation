...
theorem card_arrowDisagreement_le_sum (w : Equiv.Perm Y) :
...
exceptional blocks. -/
theorem card_hammingDisagreement_patch_le_references [DecidableEq I]
...
theorem hammingDistance_patch_le_references [DecidableEq I]
    (w : Equiv.Perm Y) (good : Finset I)
    (c : ∀ C, FinitePartialBijection (E.model C) (E.model (β.objEquiv C)))
    (hc : ∀ C ∈ good, β.RealizesOn w C (c C)) :
