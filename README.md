...
The reviewed preparation materials are [the overview](Palomar/SurjunctiveNonsoficOverview.txt) and [the source metadata](metadata/palomar-surjunctive-nonsofic.yaml). The former Palomar submission is withdrawn; these revisions have not been resubmitted.
