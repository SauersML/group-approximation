...
The reviewed preparation materials are [the overview](Palomar/SurjunctiveNonsoficOverview.txt), [the source metadata](metadata/palomar-surjunctive-nonsofic.yaml), and [the exact submission details and verification runs](Palomar/SurjunctiveNonsoficSubmission.txt). The former Palomar submission is withdrawn; these revisions have not been resubmitted.
