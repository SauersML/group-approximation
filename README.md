...
The problem was solved by Astra, using a custom proof tool. All prose for this result, this section included, and the Lean formalization were produced by Claude (Anthropic) under the user's direction. The argument was committed here on 2026-09-12 (commit 05a8aff7a) and the Lean endpoint landed the same day (commit 92ad0059d).
