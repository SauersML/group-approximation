import NonsoficGroupsExist.PropertyTT.LocalizedComplexPlane
import NonsoficGroupsExist.PropertyTT.RankFourColumnGeometry
import NonsoficGroupsExist.PropertyTT.UniformOrbitProjection
import NonsoficGroupsExist.PropertyTT.UnitaryDisplacement
...
theorem hasRelativeTTmodT_X03 :
    HasRelativeTTmodT.{_, v} (G4 X) (X03 X) := by
  intro E _ _ _ rho _hno b D hb
  let M : ℝ := embeddedControlNormSum X b
  let C : ℝ := D +
