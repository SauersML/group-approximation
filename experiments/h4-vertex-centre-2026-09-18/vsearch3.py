...
Run: python3 vsearch3.py LA LB LF K r K2 r2 K3 r3   (chunks: alpha_1 index = r mod K, alpha_2 index = r2 mod K2, beta_1 index = r3 mod K3)
Copy of vsearch.py (experiments/h4-two-flat-pencil-matching-2026-09-17) with an extra alpha_2 chunk; imports from there."""
import sys, time, os
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "h4-two-flat-pencil-matching-2026-09-17"))
import numpy as np
...
def main(LA, LB, LF=5, K=1, r=0, K2=1, r2=0, K3=1, r3=0):
    SA = words(FN, LA)
    B = [()] + words(EFF3, LB)
    ...
    for i1, a1 in enumerate(SA):
        ...
        for i2, a2 in enumerate(SA):
            ...
            for i3, (w1, b1, b1i) in enumerate(BM):
                if i3 % K3 != r3:
                    continue
