/* Monte Carlo on Cay(F2 x Z, standard generators {a,b,t}): P(|C|>=n). Vertices: F2 word encoded via hash table of (parent index, letter, height). */
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <string.h>
...
int main(int argc,char**argv){
  ...
  int Da[1]={0}, Db[1]={0};
  int gl[6],gd[6]; int g=0;
  for(int i=0;i<1;i++){gl[g]=0;gd[g++]=Da[i]; gl[g]=1;gd[g++]=-Da[i];}
  for(int i=0;i<1;i++){gl[g]=2;gd[g++]=Db[i]; gl[g]=3;gd[g++]=-Db[i];}
