"""Exact symmetric complementary-support braid audit.

Run on MSI only.  The words tested here have both outer coefficients equal
to ONE.  They collapse to the two support Whiteheads; they are not the
asymmetric mixed-braid residual x_79(q_1)x_97(q_1)x_79(1).
"""
