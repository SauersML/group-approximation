"""Exact parity/closure audit for the symmetric support-return cells.

Run on MSI only.  Tests the subgroup generated by the two symmetric words
whose outer coefficients are ONE and the native J1.  This subgroup does
not contain the asymmetric mixed-braid residual.
"""
