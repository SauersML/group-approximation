import GroupApproximation.GGT.VanKampen.Estimating.OsinAppendixEulerPhiMapTransportTwoGon
...
* `PhiMapTransport.not_regionInternal_of_crossO`: a crossing dart is in the collapsed map.
* `PhiMapTransport.phiKeepO_map_iff`, `phiKeepO_range`.
* `PhiMapTransport.phiTransportAt_of_bypass`, `phiTransportAt_of_semiconj`.
...
#audit_axioms GroupApproximation.GGT.VanKampen.PhiMapTransport.phiKeepO_map_iff
#audit_axioms GroupApproximation.GGT.VanKampen.PhiMapTransport.phiTransportAt_of_bypass
#audit_axioms GroupApproximation.GGT.VanKampen.PhiMapTransport.phiTransportAt_of_semiconj
