...
* `PhiMapTransport.RegionTransport`, with `map_mem`, `exists_map_eq`, `sideCellO_map`, `noLoops`,
  `joinsCells_map`, `noMultipleEdges`, `sharesEndO_map`, `mem_linkedComponentO_map`.
* `PhiMapTransport.extPhiData_of_leastArea`: the data of `Φ'_M` on any component, at least area.
...
#audit_axioms GroupApproximation.GGT.VanKampen.PhiMapTransport.RegionTransport.noMultipleEdges
#audit_axioms GroupApproximation.GGT.VanKampen.PhiMapTransport.RegionTransport.mem_linkedComponentO_map
#audit_axioms GroupApproximation.GGT.VanKampen.PhiMapTransport.extPhiData_of_leastArea
