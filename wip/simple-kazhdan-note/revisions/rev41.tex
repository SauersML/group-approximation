...
the next corollary answers the analogous question, with a Kazhdan host. It
parallels the theorem of Boone and Higman that a finitely generated group
has solvable word problem if and only if it embeds in a simple subgroup
of a finitely presented group~\cite{BooneHigman}.
...
marked groups, whose Cayley graphs form a family of expanders.
\end{corollary}
...
$\Gamma\le[\Delta,\Delta]\le[\Lambda,\Lambda]$. This proves
Corollary~\ref{cor:lef} and the first statement of
Corollary~\ref{cor:host}. For the second, apply the first to the
...
below. Every Turing degree occurs.
\end{corollary}
