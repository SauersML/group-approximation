...
distinct_from:
  ...
  pbh-via-bh-and-a2-kernel-removal: that uses removal to derive the permutational conjecture for a Boone--Higman group; this shows that removal for one action is itself the permutational conclusion for its image.
