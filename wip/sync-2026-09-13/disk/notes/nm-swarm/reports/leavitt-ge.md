...
- 0912-102720-64127: PROBE GREEN on the stage-1 bytes (6e2564b25); BUILT
  ...
  the first probe.
- 0912-105347-97839: PROBE GREEN on the stage-2 bytes (7db678817, the `Dismantlable` wrapper);
  BUILT `GroupApproximation.GGT.SystolicBallDismantlable`, base d56f7944a. The bytes on main equal
  the green record. `dismantlable_of_forall_dist_le` depends on axioms
